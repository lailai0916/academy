...
目标范围是浙江高考语文、数学、英语、物理、化学、技术六科。目前可用的是英语词汇与古诗词记忆训练、间隔复习和 AI 讲解；六科课程目录已经建立，首个动量定理连续课程正在接入。
...
🖥️ **公开官网与学习空间** — 公开页和登录后的课程页会区分“已实现”“接入中”和“规划中”。学习空间带分区侧栏、顶部搜索、通知和主题控制，支持浅色、深色与跟随系统主题。
...
接下来把[动量定理课程样例](docs/learning-pilot.md)接入平台，让基础检查、讲解、追问、练习、独立测评和延迟复测能够连续完成。
